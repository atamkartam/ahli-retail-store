...
<section class="hero-section text-md-start py-5"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                ...
                <a href="{{ route('customer.auth.registers.index') }}"
                   ...
                   style="background-color: #CC3333; border-radius: 8px; padding: 10px 30px;">
                    Register
                </a>
            </div>
        </div>
    ...
    <div class="container text-center">
        {{-- Judul --}}
        <h2 class="fw-bold mb-5" style="color:#A34A4A;">Mengapa Memilih Kami?</h2>

        <div class="row justify-content-center">
            {{-- Produk Original --}}
            <div class="col-md-3 mb-4">
                <i class="fas fa-certificate fa-3x text-danger mb-3"></i>
                <h5 class="fw-bold text-danger">Produk Original</h5>
                <p class="text-muted small">Kami menjamin produk yang selalu baru dan berkualitas.</p>
            </div>

            {{-- Harga Kompetitif --}}
            <div class="col-md-3 mb-4">
                <i class="fas fa-tags fa-3x text-danger mb-3"></i>
                <h5 class="fw-bold text-danger">Harga Kompetitif</h5>
                <p class="text-muted small">Dapatkan harga terbaik di pasar tanpa mengorbankan kualitas.</p>
            </div>

            {{-- Garansi Uang Kembali --}}
            <div class="col-md-3 mb-4">
                <i class="fas fa-undo fa-3x text-danger mb-3"></i>
                <h5 class="fw-bold text-danger">Garansi Uang Kembali</h5>
                <p class="text-muted small">Jika tidak puas, uang Anda akan kami kembalikan.</p>
            </div>
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="text-muted small">Pesanan Anda akan sampai tepat waktu dan aman.</p>
            </div>
        </div>
    </div>
</section>
...
<section id="best-seller" class="best-seller-section py-5">
    <div class="container">
        <h2 class="text-center" style="color: #8B0000;">Best Seller</h2>
                        ...
                        <div class="col-6">
                            <div class="card h-100 shadow-sm border-0 rounded-3 text-center">
                                ...
                                <div class="p-3 d-flex flex-column">
                                    ...
                                    <p class="mb-2 text-muted small flex-grow-1" style="font-size:0.8rem;">
                                        {{ Str::limit(strip_tags($product->description), 40) }}
                                    </p>
                                    <p class="fw-bold mb-3" style="color:#B22929; font-size:0.95rem;">
                                        Rp. {{ number_format($product->selling_price, 0, ',', '.') }}
                                    </p>

                                    {{-- Tombol Buy --}}
                                    <button class="btn w-100 text-white mt-auto"
...
<div class="d-flex justify-content-center mt-4">
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h2 class="fw-bold" style="color: #7a2c2c;">Our Fashion Story</h2>
            <p class="text-muted">
        ...
        <div class="position-relative">
            ...
            <div class="d-flex mb-4">
                ...
                <div class="card border border-danger rounded-3 shadow-sm w-100">
                    <div class="card-body">
                        <h6 class="fw-bold text-danger">2019 Awal Mula</h6>
                        <p class="mb-0 small">
            ...
            <div class="d-flex mb-4">
                ...
                <div class="card border border-danger rounded-3 shadow-sm w-100">
                    <div class="card-body">
                        <h6 class="fw-bold text-danger">2020 Momentum Pertama</h6>
                        <p class="mb-0 small">
            ...
            <div class="d-flex mb-4">
                ...
                <div class="card border border-danger rounded-3 shadow-sm w-100">
                    <div class="card-body">
                        <h6 class="fw-bold text-danger">2023 Awal Kemajuan</h6>
                        <p class="mb-0 small">
            ...
            <div class="d-flex">
                ...
                <div class="card border border-danger rounded-3 shadow-sm w-100">
                    <div class="card-body">
                        <h6 class="fw-bold text-danger">2025 Bertahan</h6>
                        <p class="mb-0 small">
...
<section class="cara-pemesanan py-5">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-center">
                        ...
                        <div class="text-center mx-3 mb-3" style="min-width:100px;">
                            <div class="rounded-circle d-flex justify-content-center align-items-center mb-2"
                                ...
                                <i class="fas fa-box fa-2x" style="color: #A34A4A;"></i>
                            </div>
                            <p class="fw-bold m-0">1. Pilih Produk</p>
                        </div>

                        <i class="fas fa-arrow-right fa-2x mx-2" style="color: #A34A4A;"></i>

                        {{-- Step 2 --}}
                        <div class="text-center mx-3 mb-3" style="min-width:100px;">
                            <div class="rounded-circle d-flex justify-content-center align-items-center mb-2"
                                 style="width:80px; height:80px; border:2px solid #A34A4A; margin:auto;">
                                <i class="fas fa-shopping-cart fa-2x" style="color: #A34A4A;"></i>
                            </div>
                        ...
                        <div class="text-center mx-3 mb-3" style="min-width:100px;">
                            <div class="rounded-circle d-flex justify-content-center align-items-center mb-2"
                                 style="width:80px; height:80px; border:2px solid #A34A4A; margin:auto;">
                                <i class="fas fa-truck-moving fa-2x" style="color: #A34A4A;"></i>
                            </div>
                        ...
                        <div class="text-center mx-3 mb-3" style="min-width:100px;">
                            <div class="rounded-circle d-flex justify-content-center align-items-center mb-2"
                                 style="width:80px; height:80px; border:2px solid #A34A4A; margin:auto;">
                                <i class="fas fa-home fa-2x" style="color: #A34A4A;"></i>
                            </div>
    ...
    <div class="container text-center">
        {{-- Judul --}}
        <h2 class="mb-2 fw-bold" style="color: #7a2c2c;">Keamanan dan Jaminan</h2>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="card p-4 h-100 shadow-sm border-0">
                    ...
                    <h5 class="fw-bold" style="color:#7a2c2c;">Keamanan Transaksi</h5>
                    <ul class="list-unstyled text-start mt-3">
                        <li><span class="text-danger me-2">✔</span> Sistem pembayaran terenkripsi dengan teknologi SSL 256-bit</li>
                        <li><span class="text-danger me-2">✔</span> Data pribadi Anda 100% tidak dibagikan ke pihak ketiga</li>
                        <li><span class="text-danger me-2">✔</span> Transaksi diawasi oleh sistem keamanan real-time</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card p-4 h-100 shadow-sm border-0">
                    ...
                    <h5 class="fw-bold" style="color:#7a2c2c;">Garansi Produk</h5>
                    <ul class="list-unstyled text-start mt-3">
                        <li><span class="text-danger me-2">✔</span> Garansi uang kembali 30 hari jika produk tidak sesuai</li>
                        <li><span class="text-danger me-2">✔</span> Gratis pengembalian produk cacat dalam 14 hari</li>
                        <li><span class="text-danger me-2">✔</span> Pertukaran ukuran atau warna tanpa biaya tambahan</li>
                    </ul>
                </div>
            </div>
        </div>

                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="{{ Storage::url($order->payment->proof_of_payment) }}" class="btn btn-info btn-sm me-2" target="_blank">
                                <i class="fas fa-file-image"></i> Bukti Bayar
                            </a>
                            @endif
                            <a href="{{ route('customer.orders.invoice', $order) }}" class="btn btn-primary btn-sm" target="_blank">
